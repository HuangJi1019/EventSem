...
--lw_giou 0.1 \
--score_weight 0.55 \
--event_sim_threshold 0.4 \
--lr 4e-4 \
--span_width_threshold 0.2 \
--semantic_t_feat_dir "/users/40448930/ji_code/FlashVTG/datasets/semantic_embeddings/qv_highlight_sbert_token_clip_tokenized" \
--n_semantic_proj 1 \
--gate -2 \
--sim_sharpness 5 \
--resume 
--resume "/users/40448930/ji_code/FlashVTG/results_all_qvhighlight/hl-video_tef-qv_slowclip_512-2025-06-17-13-57-10/model_best.ckpt" \
# --resume_all \
