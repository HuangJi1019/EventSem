...
from EventSem.config import BaseOptions
from EventSem.start_end_dataset import (
    StartEndDataset,
    start_end_collate,
    prepare_batch_inputs,
)
from EventSem.inference import eval_epoch, start_inference, setup_model
...
def train_epoch(model, criterion, train_loader, optimizer, opt, epoch_i, tb_writer):
    ...
    for batch_idx, batch in tqdm(
        ...
        model_inputs, targets = prepare_batch_inputs(batch[1], device= opt.device, non_blocking=opt.pin_memory)
