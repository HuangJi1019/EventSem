...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        #double check before run code !!!!!
        parser.add_argument("config",help="config file",default="data/MR.py")
        ...
        parser.add_argument("--use_neg", action="store_true",default=True, help="use negative samples in training")
        parser.add_argument("--dset_name", default="charadesSTA",type=str, choices=["hl", 'tvsum', 'charadesSTA', 'tacos','youtube_uni', 'qv_internvideo2', 'charadesSTA_internvideo2'])
        ...
        parser.add_argument("--exp_id", type=str, default="demo", help="id of this run, required at training")
        ...
        # training config        
        parser.add_argument("--lr_drop", nargs="+", type=int, default=[70,100], help="drop learning rate to 1/10 every lr_drop epochs")
        ...
        parser.add_argument("--clip_length", type=float, default=0.166666)
        parser.add_argument("--max_windows", type=int, default=5)

        parser.add_argument("--train_path", type=str, default="data/charades_sta/charades_sta_train_tvr_format.jsonl")
        parser.add_argument("--eval_path", type=str, default="data/charades_sta/charades_sta_test_tvr_format.jsonl",
        ...
        parser.add_argument("--v_feat_dirs", type=str, nargs="+", default=[
                "/charades/vgg_features/rgb_features"
            ], help="video feature dirs. If more than one, will concat their features. "
                                 "Note that sub ctx features are also accepted here.")
        parser.add_argument("--t_feat_dir", type=str, help="text/query feature dir",default="/features/clip_text_features")
        parser.add_argument("--a_feat_dir", type=str, help="audio feature dir")
        parser.add_argument("--v_feat_dim", type=int, help="video feature dim",default=4096)
        parser.add_argument("--t_feat_dim", type=int, help="text/query feature dim",default=300)
        ...
        parser.add_argument('--kernel_size', default=5, type=int,
                            help="Number of ")
        parser.add_argument('--num_conv_layers', default=1, type=int,
                            help="Number of ")
        ...
        parser.add_argument('--t2v_layers', default=6, type=int,
                            help="Number of ACA layers in the transformer")
        parser.add_argument('--dummy_layers', default=3, type=int,
                            help="Number of encoding layers in the transformer")
        ...
        parser.add_argument("--lw_reg", type=float, default=1.,
                            help="weight for span loss, set to 0 will ignore")
        parser.add_argument("--lw_cls", type=float, default=5,
                            help="weight for span loss, set to 0 will ignore")
        ...
        parser.add_argument('--label_loss_coef', default=0.1, type=float)
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['EventSem/model.py', 'EventSem/transformer.py']
